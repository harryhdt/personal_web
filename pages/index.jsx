        ...
        <div className="w-full max-w-5xl mx-auto">
          <div className="h-[calc(100vh-111px)] min-h-[500px] flex items-center justify-center">
            <div className="flex flex-col items-center -mt-20 relative">
              <IconCode className="stroke-1 w-60 sm:w-80 h-auto absolute text-green-400 -mr-6" />
              <IconCode className="stroke-1 w-60 sm:w-80 h-auto text-amber-400 -ml-6" />
